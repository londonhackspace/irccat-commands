...
facts = [
         ...
         'In 1776 hackspace membership was given to people not quite insane enough to be locked up in mental asylums. It is believed to have been the world\'s first community service sentence.',
         ...
         'In Hoover, Alamaba, a fight over woodworking tools led to the founding of a Church of Hackspace in 1822.',
